...
export const meta: MetaFunction = () => [
  { title: "What We Do | UCI CubeSat" },
  {
    name: "description",
    content:
      "Explore UCI CubeSat's five core engineering subsystems: Avionics, Communications, Structures, Power, and Systems.",
  },
  {
    tagName: "link",
    rel: "canonical",
    href: "https://ucicubesat.com/aboutus/what-we-do",
  },
  { property: "og:title", content: "What We Do | UCI CubeSat" },
  {
    property: "og:description",
    content:
      "Explore UCI CubeSat's five core engineering subsystems building a 2U nanosatellite.",
  },
  { property: "og:url", content: "https://ucicubesat.com/aboutus/what-we-do" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:title", content: "What We Do | UCI CubeSat" },
  {
  ...
  return (
    ...
    >
      <div className="flex-[0_0_45%] max-sm:flex-none max-sm:w-full relative">
        <div
          className={`absolute -inset-2 rounded-lg ${index % 2 === 0 ? "bg-gradient-to-br from-atmosphere/10 to-earth/5" : "bg-gradient-to-br from-earth/10 to-atmosphere/5"} blur-xl pointer-events-none`}
        />
        <img
          src={image}
          alt={`${title} subsystem`}
      ...
      <div className="flex-1">
        <h2 className="font-semibold text-[28px] text-primary m-0 mb-4 max-sm:text-2xl">
          {title}
        </h2>
        <p className="text-[15px] leading-[1.7] text-muted m-0 max-sm:text-sm">
          {description}
        </p>
      </div>
    </section>
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-[1200px] mx-auto px-6 gap-[72px] max-sm:px-5 max-sm:gap-12">
      ...
      >
        ...
        <p className="text-[15px] text-muted m-0 max-w-[480px] mx-auto">
          Our satellite is built across five core engineering subsystems.
        </p>
      </div>
