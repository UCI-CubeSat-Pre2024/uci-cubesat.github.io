...
export const meta: MetaFunction = () => [
  { title: "Contact | UCI CubeSat" },
  {
    name: "description",
    content:
      "Get in touch with UCI CubeSat. Reach out to learn more about our nanosatellite project or get involved with the team.",
  },
  {
    tagName: "link",
    rel: "canonical",
    href: "https://ucicubesat.com/contact",
  },
  { property: "og:title", content: "Contact | UCI CubeSat" },
  {
    property: "og:description",
    content:
      "Get in touch with UCI CubeSat. Reach out to learn more or get involved.",
  },
  { property: "og:url", content: "https://ucicubesat.com/contact" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:title", content: "Contact | UCI CubeSat" },
  {
    ...
    <div className="flex flex-col items-center w-full min-h-[60vh] px-6 max-sm:px-5">
      ...
      >
        ...
        <p className="text-[15px] text-muted max-w-[440px] mx-auto">
          Reach out to learn more about UCI CubeSat or get involved with the
          team.
        </p>
      </div>
      <div
      ...
      >
        ...
        <div className="relative flex flex-col gap-4 w-full">
          <div
            className={`flex flex-col gap-1 py-6 px-7 bg-orbital border border-starlight rounded-xl text-left transition-colors hover:border-earth/30 max-sm:py-5 max-sm:px-[22px] animate-on-scroll animate-delay-1 ${cardsAnimation.isVisible ? "visible" : ""}`}
          >
          ...
          >
            ...
            <a
              href="mailto:team.ucicubesat@gmail.com"
              className="text-sm font-medium text-earth mt-0.5 hover:text-atmosphere transition-colors"
            >
